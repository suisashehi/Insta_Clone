                ...
                {#each data.reports as report (report.id)}
                    <div class="bg-white border border-gray-100 rounded-2xl px-5 py-4">
                        ...
                        <p class="text-xs text-gray-400 mb-3">
                            Reported by {report.reporter} · comment by {report.commenter} · {report.reason}
                        </p>
                        <!-- Action buttons -->
                        <div class="flex gap-2">
                            ...
                            <form method="POST" action="?/deleteComment">
                                ...
                                <button type="submit" class="text-xs text-red-500 border border-red-100 hover:bg-red-50 px-3 py-1.5 rounded-lg transition">
                                    Delete comment
                                </button>
                            </form>
